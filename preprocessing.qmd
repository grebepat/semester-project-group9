...
# calculate mean distance per messenger
...
p5 <- ggplot(donner_cor,aes(x, y, color = segment_id_cor)) +
    geom_path() +
    geom_point() +
    scale_fill_brewer(palette = "Set1") +
    coord_fixed() +
...
p6 <- ggplot(raeubertochter_cor,aes(x, y, color = segment_id_cor)) +
    geom_path() +
    geom_point() +
    scale_fill_brewer(palette = "Set1") +
    coord_fixed() +
...
p7 <- ggplot(width_preference) +
  geom_boxplot(aes(x = width, y = perc))


p8 <- ggplot(width_preference_alt) +
  geom_boxplot(aes(x = width, y = perc))


p9 <- ggplot(width_preference_alt, aes(x= pref , y= width, group = width )) +
