...
housing <- st_intersection(housing, extent4)
streets <- st_intersection(streets, extent4)
surface <- st_intersection(surface, extent4)
...
tm_13 <- tm_shape(streets, bbox = extent4) + 
   tm_lines(lwd = "width", scale = 2.5, legend.lwd.show = FALSE) +
  tm_shape(housing, bbox = extent) +
  tm_polygons(col = "grey25", border.col = "white", lwd = 0.5, alpha = 0.9) +
tm_shape(nearest) + 
